...
$selfkurstitel=isset($_POST['selfkurstitel']) ? $_POST['selfkurstitel'] : (isset($_GET['selfkurstitel']) ? $_GET['selfkurstitel'] : '');
$suche->selfkurstitel=$selfkurstitel;
if(!empty($selfkurstitel)) {
  $suche->addKriterium("id in(select tnid from gpb_selfkurs_tn where selfkursid in(select id from gpb_selfkurs where titel like ?))",
    '%'.$selfkurstitel.'%','s');
}
