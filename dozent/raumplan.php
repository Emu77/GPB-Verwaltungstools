...
$kurse=new Liste('DozentKurs',$suche->prepare("select * from gpb_kurs_view where (moodleid>0 or sichtbar) and","order by ort,raum"));
...
$seite=new DozentSeite('Raumplan '.$suche->ort.' '.date('d.m.Y',strtotime($suche->am)));
