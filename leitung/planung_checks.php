...
".($ich->ort ? "left outer join gpb_raum r on r.id=k.raumid" : "")."
join gpb_dozent d on d.id=kd.dozentid
where k.beginn is not null and k.beginn<>'0000-00-00' and k.ende is not null and k.ende>=current_date()".($ich->ort ? " and r.ort=?" : ""));
if($ich->ort) {
