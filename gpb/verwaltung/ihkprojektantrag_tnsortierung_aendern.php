...
$s=isset($ich->ihkprojektantrag_tnsortierung) ? $ich->ihkprojektantrag_tnsortierung : (isset($ich->tnsortierung) ? explode(',',$ich->tnsortierung) : array('beruf','betreuer','nachname','vorname'));
