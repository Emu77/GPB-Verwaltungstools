...
$ferien=new Liste('VerwaltungFerien',$suche->prepare("select * from gpb_ferien where","order by beginn,ende,art"));
Ferien::refsLaden($ferien);

require_once $ich->istleiter ? '../leitung/LeitungSeite.php' : 'VerwaltungSeite.php';
$seite=VerwaltungSeite::$menueByUrl['../verwaltung/ferien.php'];
