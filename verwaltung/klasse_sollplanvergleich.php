...
require_once $ich->istleiter ? '../leitung/LeitungKurs.php' : 'VerwaltungKurs.php';
require_once '../Liste.php';

$klasse=Klasse::eineLaden(isset($_GET['klasseid']) ? (int)$_GET['klasseid'] : 0,$ich->istleiter ? 'LeitungKlasse' : 'VerwaltungKlasse');
if(empty($klasse)) {
